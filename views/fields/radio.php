...
<div class="form-group">
    ...
    <?php foreach ($options as $option): ?>
        <label class="radio-inline"><input type="radio" name="<?php echo 'data[' . $question->surv_ques_id . ']'; ?>" value="<?php echo $option; ?>" <?php echo ($option === $posted) ? 'checked' : ''; ?>><?php echo $option; ?></label>
    <?php endforeach; ?>
